...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen text-3xl text-white">
        ...
        {session?.user ? (
          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center w-screen h-screen">
              ...
              <div className="flex flex-col gap-12 ml-auto mr-56 blur-none">
                <div className="flex flex-row m-auto align-middle justify-middle" >
                ...
                <button onClick={() => signIn()} className="px-5 py-3 mt-4 text-xl bg-green-500 rounded-xl">
                  Sign In
                </button>
              </div>
            </div>
